...
from OptimumTemperature import T_opt
from modelling1stRX import F_span_out
...
def PBR(V, arr, L, LD):
    ...
    D = L/LD
    Ac = (np.pi*D**2)/4
    r_IB_ane, r_IB, r_1B, r_B_diene, r_NB_ane, r_trans_B, r_cis_B, r_water, r_EtOH, r_TBA, r_ETBE, r_di_IB, r_tri_IB = rate_ls = [rhob*r*Ac for r in RATE(T, P, Q, Fls)]
    dT = EB_ada(T, P, Q, Fls)
    dQ = 0
     # m
